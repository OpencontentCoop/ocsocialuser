...
if ( $accountKey )
{
    ...
    $socialUser->setModerationMode( false );
...
elseif( $mainNodeID )
{
    ...
    if ( $userContentObject instanceof eZContentObject )
    {
        ...
        if ( $userSetting instanceof eZUserSetting && $userSetting->attribute( 'is_enabled' ) )
        {
            $alreadyActive = true;
        }
    }
...
$Result = array();
$Result['content'] = $tpl->fetch( 'design:social_user/activate.tpl' );
